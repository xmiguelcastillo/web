...
function Detection() {
  return (
    <div>
      <div className='text-white flex justify-center mt-3'>Ai Detection</div>
      <div className=' h-64 w-[500px] mt-3 rounded-lg shadow shadow-black bg-[#111111] border-[1px]  border-[#222224]' >
        ...
        <div className='flex-col  w-full h-1/5'>
          <div className=' text-white flex  justify-center items-center text-sm'>Neural Networks</div>
          ...
          <div className=' text-[#757a83] flex justify-center items-center text-xs'>Face Detection</div>
